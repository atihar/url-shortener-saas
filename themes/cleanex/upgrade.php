        ...
        <div class="col-md-6">
          <?php if ($discountMax): ?>
            <div class="faq-list clearfix">
              ...
              <p class="info"><?php printf(e("Definitely! If you choose to pay yearly, not only will you make great use of premium features but also you will get a discount of up to %d&#37."), $discountMax) ?></p>
            </div>                  
          <?php endif ?>            
        </div>
        <div class="col-md-6">
